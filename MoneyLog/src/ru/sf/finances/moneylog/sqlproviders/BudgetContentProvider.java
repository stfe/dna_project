...
public class BudgetContentProvider extends ContentProvider {
    ...
    // database
    private BudgetDatabaseHelper database;
    ...
    private static final String BASE_PATH = "budgets";
    ...
    static {
        sURIMatcher.addURI(AUTHORITY, BASE_PATH, BUDGETS);
        sURIMatcher.addURI(AUTHORITY, BASE_PATH + "/#", BUDGET_ID);
    }

    @Override
    public boolean onCreate() {
        database = new BudgetDatabaseHelper(getContext());
        return false;
    }
    ...
    private void checkColumns(String[] projection) {
        String[] available = {BudgetTable.COLUMN_ACCOUNT,
